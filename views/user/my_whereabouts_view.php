 		...
 		getGrid: function()
 		{
 			...
 			var Objstore = new Ext.data.Store({
 						proxy: new Ext.data.HttpProxy({
 							url: "<?php echo site_url("user/getWhereabouts")?>",
 							method: "POST"
 							}),
 				...
 				cm:  new Ext.grid.ColumnModel(
 						[
 											...
 											//	expander,
                                                  ...
                                                  { header: "Call Log", dataIndex: "call_log", width: 100, sortable: true, renderer: this.timeFormat},
                                                  { header: "Client Schedule", dataIndex: "client_schedule", width: 100, sortable: true, renderer: this.timeFormat},
                                                  { header: "Training", dataIndex: "training", width: 100, sortable: true, renderer: this.timeFormat}
...
var _window = new Ext.Panel({
        ...
        timeFormat: function(val){
			...
			switch(val){
				...
				case "TRAINING"	: 	fmtVal = '<span style="color: green; font-weight: bold;">'+val+'</span>'; break;
