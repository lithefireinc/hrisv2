...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title id='title'>HRISV2</title>

        <!-- ** CSS ** -->
        <!-- base library -->
        <link rel="stylesheet" type="text/css" href="/hrisv2/css/ext-all.css" />
...
{	background-attachment: fixed;
	...
	background-image: url(http://www.pixelcatalyst.net/hrisv2/images/login.png);
