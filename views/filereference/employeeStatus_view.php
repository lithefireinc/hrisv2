<script type="text/javascript">
 Ext.namespace("hrisv2_employee_status");
 hrisv2_employee_status.app = function()
 {
 	return{
 		init: function()
 		{
 		...
 		getGrid: function()
 		{
 			...
 			var grid = new Ext.grid.GridPanel({
 				...
 				cm:  new Ext.grid.ColumnModel(
 						[
 						  ...
 						  { header: "EmployeeStatus", width: 300, sortable: true, dataIndex: "description" }
 						]
 				),
 			...
 			hrisv2_employee_status.app.Grid = grid;
 			hrisv2_employee_status.app.Grid.getStore().load({params:{start: 0, limit: 25}});
 			...
 			var _window = new Ext.Panel({
 		        ...
 		        draggable: false,
 		        layout: 'fit',
 		        items: [hrisv2_employee_status.app.Grid],
 		        resizable: false
 		    ...
 		    hrisv2_employee_status.app.Form = form;
 		},
 		Add: function(){

 			hrisv2_employee_status.app.setForm();

 		  	var _window;

 		    _window = new Ext.Window({
 		        title: 'New EmployeeStatus',
 		        width: 510,
 		        height:170,
 		        layout: 'fit',
 		        plain:true,
 	                ...
 	                handler: function () {
 		                ...
 		                hrisv2_employee_status.app.Form.getForm().submit({
 			                success: function(f,action){
 				                ...
 				                ExtCommon.util.refreshGrid(hrisv2_employee_status.app.Grid.getId());
 				                _window.destroy();
 			                },
 		...
 		Edit: function(){
 			...
 			if(ExtCommon.util.validateSelectionGrid(hrisv2_employee_status.app.Grid.getId())){//check if user has selected an item in the grid
 			var sm = hrisv2_employee_status.app.Grid.getSelectionModel();
 			var id = sm.getSelected().data.id;

 			hrisv2_employee_status.app.setForm();
 		    _window = new Ext.Window({
 		        title: 'Update EmployeeStatus',
 		        width: 510,
 		        height:170,
 		        layout: 'fit',
 		        plain:true,
 ...
 Ext.onReady(hrisv2_employee_status.app.init, hrisv2_employee_status.app);
