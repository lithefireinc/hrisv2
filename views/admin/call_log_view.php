 		...
 		getGrid: function()
 		{
 			...
 			var Objstore = new Ext.data.Store({
 						proxy: new Ext.data.HttpProxy({
 							url: "<?php echo site_url("admin/getCallLog")?>",
 							method: "POST"
 							}),
 				...
 				cm:  new Ext.grid.ColumnModel(
 						[
 						  { header: "Id", dataIndex: "id", width: 100, sortable: true},
                                                  { header: "Call Log Type", dataIndex: "call_log_type", width: 150, sortable: true},
 						  { header: "Employee Name", width: 200, sortable: true, dataIndex: "employee_name" },
                                                  ...
                                                  { header: "Leave Filed", dataIndex: "leave_filed", width: 100, sortable: true, renderer: this.leaveFormat}
 						]
 				),
...
var _window = new Ext.Panel({
 		    ...
 		    var form = new Ext.form.FormPanel({
 		        ...
 		        items: [ {
 					...
 					width:'100%',
 					height:'auto',
 					items:[call_log.app.callLogTypeCombo(),
 		    ...
 		    _window = new Ext.Window({
 		  	...
 		  	call_log.app.Form.getForm().load({
 				...
 				success: function(form, action){
                                    ...
                                    Ext.getCmp('call_log_type').setRawValue(action.result.data.calllog);
        ...
        setNoOfDays: function(){
			...
			return fmtVal;
                ...
                <?php include_once("memo_view.js");?>,
                <?php include_once("notification_view.js");?>,
                <?php include_once("suspension_view.js");?>//end of functions
 	}
